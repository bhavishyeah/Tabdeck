...
- Use multiple workspaces for different contexts (Work, Personal, etc.)
...
3. Choose a folder from your Chrome bookmarks
4. Your bookmarks will appear as a board!
...
### Add a widget:
- Click the **Grid icon** (Widgets) button in the top bar
- Choose from: **Note**, **Todo List**, **Weather**, or **Clock**

### Set a wallpaper:
- Open the ⋯ menu
- Click the **Image icon** 🖼️
- Choose any image, GIF, or video from your computer

### Drag boards around:
- Grab the **thin bar** at the very top of any board
...
| `Ctrl+M` | Show/hide the toolbar |
| `Ctrl+Z` | Undo |
| `Ctrl+Y` | Redo |
| `Alt+N` | New note |
| `Alt+T` | New todo list |
| `Alt+W` | New weather widget |
| `Alt+L` | Lock/unlock your layout |
| `Alt+S` | Focus search bar |
| `Alt+E` | Export your data |

---

## 💡 Tips & Tricks

- **Right-click** on a board name to rename, change color, or delete it
- **Right-click** on a bookmark to rename or delete it
- **Drag a bookmark by its favicon** to move it to another board
- **Lock your layout** (🔒 button) to prevent accidental moves
- **⚙️ Settings** (bottom-right gear icon) to change fonts, colors, and more
